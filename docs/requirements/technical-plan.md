...
- **Явно НЕ в MVP:** _(перенесено в план)_
- **Как вписываемся в ограничения:** статический импорт JSON, никакого сервера, данные обновляет агент вручную

## Расширенный план (после MVP)

- **Автоматический парсинг в реальном времени** — агент периодически обновляет `competitors.json` по запросу или расписанию
- **Экспорт в PDF/Excel** — выгрузка таблицы сравнения и карточек конкурентов
- **Интеграция с Jira** — создание задач на основе выявленных пробелов в фичах
- **Интеграция с Confluence** — публикация сравнительной таблицы как страницы
