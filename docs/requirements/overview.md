...
- Backend as Vercel serverless functions + Turso DB for persistence, jobs, and integrations — see [ADR 002](../decisions/002-add-backend.md), [ADR 003](../decisions/003-deploy-vercel-serverless.md)
